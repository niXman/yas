...
#ifndef __yas__tests__base__include__boost_cont_multimap_hpp
#define __yas__tests__base__include__boost_cont_multimap_hpp

/***************************************************************************/

template<typename archive_traits>
bool boost_cont_multimap_test(std::ostream &log, const char *archive_type, const char *test_name) {
	boost::container::multimap<int, int> imap, imap2;
	imap.emplace(1, 2);
	imap.emplace(3, 3);
	imap.emplace(3, 4);
...
#endif // __yas__tests__base__include__boost_cont_multimap_hpp
