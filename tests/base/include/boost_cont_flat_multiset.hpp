...
#ifndef _yas_test__boost_cont_flat_multiset_hpp
#define _yas_test__boost_cont_flat_multiset_hpp
...
bool boost_cont_flat_multiset_test(const char* archive_type, const char* io_type) {
	...
	if ( set1.size() != 10 || set2.size() != 10 || set1 != set2 ) {
		std::cout << "BOOST::CONTAINER::FLAT_MULTISET deserialization error![1]" << std::endl;
		return false;
	}
	...
	if ( set3.size() != 3 || set4.size() != 3 || set3 != set4 ) {
		std::cout << "BOOST::CONTAINER::FLAT_MULTISET deserialization error![2]" << std::endl;
		return false;
	}
...
#endif // _yas_test__boost_cont_flat_multiset_hpp
