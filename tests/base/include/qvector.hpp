...
#ifndef __yas__tests__base__include__qvector_hpp
#define __yas__tests__base__include__qvector_hpp

/***************************************************************************/

template<typename archive_traits>
bool qvector_test(std::ostream &log, const char *archive_type, const char *test_name) {
	QVector<std::uint32_t> v, vv;
	v.push_back(65464);
	v.push_back(32767);
	v.push_back(2);
	v.push_back(3);
    ...
    QVector<bool> obvec{true, false}, ibvec;
...
#endif // __yas__tests__base__include__qvector_hpp
