...
#ifndef __yas__tests__base__include__qlist_hpp
#define __yas__tests__base__include__qlist_hpp

/***************************************************************************/

template<typename archive_traits>
bool qlist_test(std::ostream &log, const char *archive_type, const char *test_name) {
	QList<int> ilist1, ilist2;
	ilist1.push_back(2);
	ilist1.push_back(3);
	ilist1.push_back(6);
	ilist1.push_back(8);
...
#endif // __yas__tests__base__include__qlist_hpp
