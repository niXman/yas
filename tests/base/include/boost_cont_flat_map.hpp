...
bool boost_cont_flat_map_test(std::ostream &log, const char *archive_type, const char *test_name) {
	boost::container::flat_map<int, int> int_map, int_map2;
	int_map.emplace(1, 2);
	int_map.emplace(1, 2);
	int_map.emplace(2, 3);
	int_map.emplace(3, 4);
	...
	oa & YAS_OBJECT_NVP("obj", ("map", int_map));

	typename archive_traits::iarchive ia;
	archive_traits::icreate(ia, oa, archive_type);
	ia & YAS_OBJECT_NVP("obj", ("map", int_map2));
