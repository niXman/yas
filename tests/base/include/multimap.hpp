...
#ifndef __yas__tests__base__include__multimap_hpp
#define __yas__tests__base__include__multimap_hpp
...
bool multimap_test(std::ostream &log, const char *archive_type, const char *test_name) {
    ...
    std::multimap<std::string, std::string, std::less<>> map5, map6;
    map5.emplace("1", "1");
    map5.emplace("2", "2");
    map5.emplace("3", "3");
    map5.emplace("3", "3");
    ...
    if ( map5.size() != 4 || map6.size() != 4 || map5 != map6 ) {
        YAS_TEST_REPORT(log, archive_type, test_name);
        return false;
    }
