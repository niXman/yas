...
#ifndef __yas__tests__base__include__qmap_hpp
#define __yas__tests__base__include__qmap_hpp

/***************************************************************************/

template<typename archive_traits>
bool qmap_test(std::ostream &log, const char *archive_type, const char *test_name) {
	QMap<int, int> imap, imap2;
	imap.insert(1, 2);
	imap.insert(1, 2);
	imap.insert(2, 3);
	imap.insert(3, 4);
...
#endif // __yas__tests__base__include__qmap_hpp
