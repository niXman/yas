...
> {
	...
	static Archive& save(Archive& ar, const QStringList &list) {
		return concepts::list::save<F>(ar, list);
	}

	template<typename Archive>
	static Archive& load(Archive& ar, QStringList& list) {
...
#endif // __yas__types__qt__qstringlist_serializers_hpp
