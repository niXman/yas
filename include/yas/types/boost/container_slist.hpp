...
#ifndef __yas__types__boost__boost_container_slist_serializers_hpp
#define __yas__types__boost__boost_container_slist_serializers_hpp
...
> {
	...
	static Archive& save(Archive &ar, const boost::container::slist<T> &list) {
		return concepts::forward_list::save<F>(ar, list, list.size());
	}
...
#endif // __yas__types__boost__boost_container_slist_serializers_hpp
