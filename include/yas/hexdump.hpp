...
#ifndef __yas__hexdump_hpp
#define __yas__hexdump_hpp
...
inline std::ostream& hexdump(std::ostream &os, const void *buf, std::size_t len) {
	if ( !buf || !len ) return os;
...
inline std::ostream& hexdump(std::ostream &os, const intrusive_buffer &buf) {
    return hexdump(os, buf.data, buf.size);
}

inline std::ostream& hexdump(std::ostream &os, const shared_buffer &buf) {
    return hexdump(os, buf.data.get(), buf.size);
}

inline std::string hexdump(const void *ptr, std::size_t size) {
...
inline std::string hexdump(const intrusive_buffer &buf) {
    return hexdump(buf.data, buf.size);
}

inline std::string hexdump(const shared_buffer &buf) {
    return hexdump(buf.data.get(), buf.size);
}
