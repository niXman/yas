...
#ifndef _yas__text__boost_fusion_tuple_serializer_hpp__included_
#define _yas__text__boost_fusion_tuple_serializer_hpp__included_
...
#define YAS__TEXT__WRITE_BOOST_FUSION_TUPLE_SIZE(count) \
...
#define YAS__TEXT__READ_AND_CHECK_BOOST_FUSION_TUPLE_SIZE(count) \
   boost::uint8_t size = 0; \
   ar.read(&size, sizeof(size)); \
   BOOST_ASSERT_MSG(size == count, "size error on deserialize fusion::tuple")
...
#define YAS__TEXT__GENERATE_EMPTY_SAVE_SERIALIZE_BOOST_FUSION_TUPLE_SPEC() \
   ...
   struct serializer<e_type_type::e_type_type::not_a_pod,e_ser_method::use_internal_serializer, \
      e_archive_type::text, e_direction::out, boost::fusion::tuple<> > \
   { \
...
#define YAS__TEXT__GENERATE_EMPTY_LOAD_SERIALIZE_BOOST_FUSION_TUPLE_SPEC() \
   template<> \
   struct serializer<e_type_type::e_type_type::not_a_pod,e_ser_method::use_internal_serializer, \
      e_archive_type::text, e_direction::in, boost::fusion::tuple<> > \
   { \
      template<typename Archive> \
...
#define YAS__TEXT__GENERATE_SAVE_SERIALIZE_BOOST_FUSION_TUPLE_FUNCTION_SPEC(unused, count, unused2) \
   ...
   { \
      ...
      { \
         YAS__TEXT__WRITE_BOOST_FUSION_TUPLE_SIZE(YAS_PP_INC(count)); \
         YAS_PP_REPEAT( \
            YAS_PP_INC(count), \
...
#define YAS__TEXT__GENERATE_LOAD_SERIALIZE_BOOST_FUSION_TUPLE_FUNCTION_SPEC(unused, count, unused2) \
   ...
   { \
      ...
      { \
         YAS__TEXT__READ_AND_CHECK_BOOST_FUSION_TUPLE_SIZE(YAS_PP_INC(count)); \
         YAS_PP_REPEAT( \
            YAS_PP_INC(count), \
...
#endif // _yas__text__boost_fusion_tuple_serializer_hpp__included_
